...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`consumer_port_id`) REFERENCES `consumer_port` (`port_id`),
  CONSTRAINT `orders_ibfk_3` FOREIGN KEY (`seller_port_id`) REFERENCES `seller_port` (`port_id`)
